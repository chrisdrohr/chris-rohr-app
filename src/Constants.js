...
export const summary = [
  ...
  <span>
    Versatile and passionate <span style={{ color: '#03a9f4' }}>Front End Web Developer</span> with 2+ years of experience designing and writing mobile-first responsive Web and Android applications. Specializes in React.js, PWA, and always looking to learn new skills.
  </span>
];
